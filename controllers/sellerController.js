...
class CategoryController {
  ...
  static getAll = async (_req, res) => {
    const responseData = await SellerService.getAll();
    return constructResponse(res, responseData);
  };
  ...
  static block = async (req, res) => {
    const { user_id } = req.body;
    const responseData = await SellerService.block(user_id);
    return constructResponse(res, responseData);
  };

  static unblock = async (req, res) => {
    const { user_id } = req.body;
    const responseData = await SellerService.unblock(user_id);
    return constructResponse(res, responseData);
  };
}
